 ...
 * Read "ServInfo Server Info" (file "info.php") @ MENU -> Custom Menu -> ServInfo Server Info
 * You can edit "userMenu.php" to add or change the Custom Menu items, these changes will not be affected by updates.
*/
	...
	<nav class="navbar navbar-inverse" role="navigation">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="glyphicon glyphicon-cog"></i> <?php echo "Main Menu"; ?> <span class="caret"></span></a>
